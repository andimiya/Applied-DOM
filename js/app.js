...
btn2.addEventListener('click', () => {
  ...
  btn4.addEventListener('click', anotherFunction);
  ...
  btn6.addEventListener('click', btn6Function);
  function btn6Function(){
   ...
   */
   ...
   btn11.addEventListener('click', btn11Function);
   function btn11Function(){
    setLight11Green();
   }
